...
A partir de este análisis, se definió el esquema del fútbol como se muestra en \ref{tab:esquema_fútbol}
...
corpus (~\cite{reiter_dale_2000}). Se seleccionaron 4 jornadas (las 22,23,24,25) de la Liga Española de Fútbol Profesional de la temporada 
...
o en tandas de penales (\ref{fig_momentos_definición}). Para cada uno de estos tipos de definición se definen plantillas específicas a la hora de construir la presentación. Asimismo, en la presentación se incluye la información 
