\chapter{Esquema y modelo para el fútbol y el boxeo}\label{chapter:validation}
...
fútbol como deporte. Trabajos previos que también abordaron este deporte para la generación de texto \brackcite{theune2001data,aires2016automatic,van2017pass} se tuvieron en cuenta. 
...
%La arquitectura general planteada se presenta en \ref{arquitecturadelmodelo} y constituye una 
%adaptación de la propuesta de Aires \brackcite{aires2016automatic} que a su vez sigue un enfoque basado en la propuesta de Theune y col. \brackcite{theune2001data}. A diferencia de ambas propuestas, el 
...
corpus \brackcite{reiter_dale_2000}. Se seleccionaron 4 jornadas (las 22,23,24,25) de la Liga Española de Fútbol Profesional de la temporada 
...
Boxeo\footnote[2]{https://wbcboxing.com/} (\emph{World Boxing Council}) como referencia para las distintas categorías de pesaje tanto en boxeo masculino como en 
boxeo femenino.
