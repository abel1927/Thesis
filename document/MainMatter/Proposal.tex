...
\textbf{Eventos principales}\\
    ...
    gol de penal y gol simple. A su vez, las cirscunstancias de la acción condicionan a la hora de expresar el resultado 
    de un gol. Se identifica que un gol puede ser el primer gol del partido, o el único gol del partido, o pueden empatar 
...
A continuación se muestra el dos variantes distintas producidas por el modelo para un mismo partido.